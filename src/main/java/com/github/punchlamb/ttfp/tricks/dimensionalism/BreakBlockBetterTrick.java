package com.github.punchlamb.ttfp.tricks.dimensionalism;
...
public class BreakBlockBetterTrick extends Trick<BreakBlockBetterTrick> {

    public BreakBlockBetterTrick() {
        super(Pattern.of(4, 5, 8, 4, 3, 0, 1, 4), Signature.of(FragmentType.VECTOR, BreakBlockBetterTrick::run));
    }
